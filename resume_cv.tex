...
\address{Belgrade, Republic of Serbia}
\mobile{(+381) 616920298}

\email{aleksandarvukovic@tutanota.com}
% \homepage{www.posquit0.com}
% \github{https://github.com/sekirce/cv-latex/blob/main/resume_cv.pdf}
...
\makecvfooter{\today}{Aleksandar N. Vuković~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
